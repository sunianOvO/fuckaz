...
locations = ['eastus', 'eastus2', 'southcentralus', 'westus3', 'australiaeast',
             'southeastasia', 'northeurope', 'swedencentral', 'uksouth', 'westeurope',
             'centralus', 'southafricanorth', 'centralindia', 'eastasia', 'japaneast',
             'koreacentral', 'canadacentral', 'francecentral', 'norwayeast', 'switzerlandnorth',
             'uaenorth', 'brazilsouth', 'qatarcentral', 'northcentralus', 'westus', 'australiacentral',
             'australiasoutheast', 'japanwest', 'southindia', 'canadaeast', 'ukwest']
    ...
    for a in range(0, size_count):
        ...
        get_default_cli().invoke(
            ['vm', 'create', '--resource-group', 'ResourceGroup', '--name',
             ...
             './.XX/cloud-shell/cloud-init.txt', "--no-wait"])
